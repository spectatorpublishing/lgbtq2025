export const credits = {
    ...
    "Engineering": [
      ...
      { staff_name: "Janice Wong", title: "Associate Developer" },
    ],
  
    "Product": [
      { staff_name: "Melinda Yao", title: "Product Manager" },
      { staff_name: "Babajide Hamzat", title: "Product Designer" },
    ...
    "University News": [
      ...
      { staff_name: "Wiann Wilson", title: "Staff Writer" },
      { staff_name: "Harriet Engelke", title: "Staff Writer" },
      { staff_name: "Samantha Elkins", title: "Staff Writer" },
      { staff_name: "Saul Quintanar", title: "Staff Writer" },
      { staff_name: "Ria Vasishtha", title: "Staff Writer" },
    ],
    ...
    "A&C": [
      ...
      { staff_name: "Lily O'Brien", title: "Arts & Culture Staff Writer" },
    ],
    ...
    "Illustrations": [
      ...
      { staff_name: "Thomas Diaz", title: "Illustrator" },
    ],
    ...
    "Graphics": [
      ...
      { staff_name: "Arabelle Park", title: "Graphics Reporter" },
    ],
  
    "City News": [
      { staff_name: "Thomas Stewart", title: "Deputy News Editor" },
      { staff_name: "Danielis Morales Villegas", title: "Staff Writer" },
    ],
    ...
    "Video": [
      ...
      { staff_name: "Mathilda Turich", title: "Video Associate" },
    ],
  
    "Crosswords": [
      { staff_name: "Ananya Govindarajan", title: "Head of Crosswords" },
      { staff_name: "Olivia Barbieri", title: "Crosswords Senior Associate" },
